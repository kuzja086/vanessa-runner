...
Функция ВозможныеКоманды() Экспорт
	...
	Если мВозможныеКоманды = Неопределено Тогда
		...
		мВозможныеКоманды.Вставить("ОбновитьИБПриРазработкеВЕДТ", "edtToConf");
...
Процедура ПриРегистрацииКомандПриложения(Знач КлассыРеализацииКоманд) Экспорт
	...
	КлассыРеализацииКоманд[ВозможныеКоманды().ОбновитьИБПриРазработкеВЕДТ]	= "КомандаОбновитьИБПриРазработкеВЕДТ";
	//...
